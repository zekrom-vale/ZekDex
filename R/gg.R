...
#' @param aesthetics The aesthetic mapping to use for the fill scale. Default is "color".
#'
...
ggtypes = function(
		types = type_colors$new, aesthetics = "color"
){
	# Return the scale_fill_manual call with the Pokémon type colors
	scale_fill_manual(values = types, aesthetics = aesthetics)
}
