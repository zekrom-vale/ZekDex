...
#'	\item{`form`}{`character` Form of the Pokemon. This refers to the different physical forms that Pokémon can take. NA if the Pokemon does not have a special form.}
#'	\item{`regional`}{`factor` Regional form of the Pokemon. This refers to the variations of Pokémon that appear differently and have different attributes compared to their counterparts in other regions. NA if the Pokemon does not have a regional form.}
#'	\item{`Gen`}{`factor` The generation the Pokemon was introduced in. This refers to the different stages of Pokémon games, each introducing new Pokémon, regions, and gameplay concepts.}
#'	\item{`Mega`}{`character` The Mega form. These are special forms that certain Pokémon can take.}
#'	\item{`MegaOrPrimal`}{`factor` Indicates if the Pokémon is in a Mega or Primal form. These are special forms that certain Pokémon can take.}
#'	\item{`Exp`}{`integer` The experience yield of the Pokemon.}
#'	\item{`note`}{`character` Any additional notes about the Pokemon. NA if there are no additional notes.}
#'	\item{`HP`}{`integer` The HP effort value yield of the Pokemon.}
#'	\item{`Attack`}{`integer` The Attack effort value yield of the Pokemon.}
#'	\item{`Defense`}{`integer` The Defense effort value yield of the Pokemon.}
#'	\item{`SpAttack`}{`integer` The Special Attack effort value yield of the Pokemon.}
#'	\item{`SpDefense`}{`integer` The Special Defense effort value yield of the Pokemon.}
#'	\item{`Speed`}{`integer` The Speed effort value yield of the Pokemon.}
#'	\item{`TotalEVs`}{`integer` The total effort value yield of the Pokemon.}
#' }
#' @source [List of Pokémon by effort value yield (Generation III). In Bulbapedia.](https://bulbapedia.bulbagarden.net/wiki/List_of_Pok%C3%A9mon_by_effort_value_yield_(Generation_III))
...
#'
#' @references [Effort Values. In Bulbapedia.](https://bulbapedia.bulbagarden.net/wiki/Effort_values)
#'
#' @examples
#' data(evYield)
"evYield"
